    ...
    >
      ...
      <div className="flex items-center pr-4 md:pr-16">
        <Popover className="relative">
          ...
          >
            <Popover.Panel className="absolute -right-16 sm:right-4 z-50 mt-4 bg-white shadow-sm rounded max-w-xs sm:max-w-sm w-screen">
              <div className="relative p-4 rounded-4xl">
